...
> ${t}</span>
`,!1)}$(window).scrollTop(0)},renderRedPacket:function(i,e,t,a,n,o){let l=!1,r=-1,c,s;if(void 0!==n&&(c=n.winnerResult,s=n.diceParticles),e===t)for(let e=0;e<i.length;e++){var d=i[e];d.userMoney>r&&(r=d.userMoney)}for(let s=0;s<i.length;s++){var p=i[s],u=p.userMoney,m=p.dice,h=p.userName;h===Label.currentUser&&(void 0!==u?0<u?$("#redPacketIGot").text("抢到了 "+u+" 积分"):0==u?$("#redPacketIGot").text("恭喜你，抢了个寂寞"):$("#redPacketIGot").text("什么运气，你竟然被反向抢红包了"):void 0!==m&&$("#redPacketIGot").text("押注 "+m.chips+" 积分"),l=!0);let e="",t=h;switch(e=void 0!==m?m.bet:e){case"big":t=h+" (押大)";break;case"small":t=h+" (押小)";break;case"leopard":t=h+" (豹子)"}var f=p.time;let a="",n=`<li class="fn__flex menu__item">${a=void 0!==p.avatar?`<img class="avatar avatar--mid" style="margin-right: 10px; background-image: none; background-color: transparent;" src="${p.avatar}">`:a}
<div class="fn__flex-1" style="text-align: left !important;">
<h2 class="list__user"><a href="${Label.servePath}/member/${h}">${t}</a>
</h2>`;0<u&&u===r?(r=-1,n+="<span class='green small btn'>来自老王的认可</span><br>\n"):0===u?n+="<span class='red small btn'>0溢事件</span><br>\n":u<0&&(n+="<span class='yellow small btn'>抢红包有风险</span><br>\n"),void 0!==c&&(c===m.bet?n+="<span class='green small btn'>运气好而已</span><br>\n":n+="<span class='red small btn'>别玩了</span><br>\n");let o;o=void 0===u&&void 0!==m?m.chips:u,n+=`<span class="ft__fade ft__smaller">${f}</span>
    </div>
