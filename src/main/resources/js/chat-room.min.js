...
</div>`),$.ajax({url:Label.servePath+"/chat-room/si-guo-list",type:"GET",cache:!1,async:!1,success:function(e){var a=e.data;0==a.length&&$("#si-guo-list").prepend('<li style="color: #3caf36; font-weight: bold;">目前沒有受到處罰的魚油，請繼續保持！</li>');for(let t=0;t<a.length;t++){var n=a[t],o=new Date(n.time),s=n.userAvatarURL;let e=n.userName;n=n.userNickname;""!=n&&(e=n),$("#si-guo-list").prepend(`
    <li class="fn__flex menu__item">
        <img class="avatar avatar--mid" style="width: 24px; height: 24px; margin-right: 10px; background-image: none; background-color: transparent; filter: blur(1px);" src="`+s+`">
        <div class="fn__flex-1" style="text-align: left !important;">
            <h2 class="list__user">
                <a target="_blank" href="`+Label.servePath+"/member/"+e+'" style="color: #c0c0c0; text-decoration: none;">'+e+`</a>
            </h2>
        </div>
        <div class="fn__flex-center" style="color: #ff1919; font-weight: bold">將於 `+o.getFullYear()+"年"+(o.getMonth()+1<10?"0"+(o.getMonth()+1):o.getMonth()+1)+"月"+o.getDate()+"日 "+o.getHours()+"時"+o.getMinutes()+`分 釋放</div>
    </li>
