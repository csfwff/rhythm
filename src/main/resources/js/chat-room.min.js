...
</ul></div>`,"红包"),ChatRoom.renderRedPacket(t.who,t.info.count,t.info.got,t.recivers,t.diceRet,t.info.userName),t.info.count===t.info.got&&($("#chatroom"+a).find(".hongbao__item").css("opacity",".36").attr("onclick","ChatRoom.unpackRedPacket("+a+")"),$("#chatroom"+a).find(".hongbao__item").hasClass("opened")||$("#chatroom"+a).find(".hongbao__item").addClass("opened"),!0===t.dice?$("#chatroom"+a).find(".redPacketDesc").html("已开盘"):$("#chatroom"+a).find(".redPacketDesc").html("已经被抢光啦"))}else Util.alert(t.msg)},error:function(e){Util.alert(e.msg)}})},plusOne:function(){ChatRoom.editor.setValue(Label.latestMessage),ChatRoom.send()},renderMsg:function(s,a){if(!(0<ChatRoom.shileds.indexOf(s.userName))){var i=s.userName,r=s.content,l=s.md||"",c=s.userAvatarURL,d=ChatRoom.remarkList[s.userOId];if(!a&&catchUsers.includes(i)&&-1==r.indexOf('"msgType":"redPacket"')){var u='<div class="robot-msg-item"><div class="avatar" style="background-image: url('+c+')"></div><div class="robot-msg-content"><div class="robot-username"><p>'+i+"</p></div> "+r+' <div class="fn__right" style="margin-top: 5px; font-size: 10px;">'+s.time+"</div></div></div>";ChatRoom.addRobotMsg(u)}else if(!a&&$("#catch-word").prop("checked")&&-1==r.indexOf('"msgType":"redPacket"')&&(l.startsWith("鸽 ")||l.startsWith("小冰 ")||l.startsWith("凌 ")||l.startsWith("ida "))){u='<div class="robot-msg-item"><div class="avatar" style="background-image: url('+c+')"></div><div class="robot-msg-content"><div class="robot-username"><p>'+i+"</p></div> "+r+' <div class="fn__right" style="margin-top: 5px; font-size: 10px;">'+s.time+"</div></div></div>";ChatRoom.addRobotMsg(u)}else{let e=!1;l=Label.latestMessage===s.md;try{var p=$.parseJSON(s.content.replace("<p>","").replace("</p>",""));if("redPacket"===p.msgType){e=!0;let t="未知类型红包",a="ChatRoom.unpackRedPacket('"+s.oId+"')";switch(p.type){case"random":t="拼手气红包";break;case"average":t="普通红包";break;case"specify":t="专属红包";break;case"heartbeat":t="心跳红包 (慎抢)";break;case"rockPaperScissors":t="石头剪刀布红包",p.senderId!=Label.currentUserId&&(a="");break;case"dice":if(t="摇骰子",p.senderId!==Label.currentUserId){let e=!1;for(idx in p.who)if(p.who[idx].userId===Label.currentUserId){e=!0;break}e||(a="ChatRoom.bet('"+s.oId+"')")}}if(Number(p.count)===Number(p.got)){let e="已经被抢光啦";"dice"===p.type&&(e="已开盘"),s.content='<div style="opacity: .36;" class="hongbao__item fn__flex-inline" onclick="ChatRoom.unpackRedPacket(\''+s.oId+'\')">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+p.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+p.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n'+e+"\n        </div>\n    </div>\n</div>"}else"rockPaperScissors"===p.type&&p.senderId!=Label.currentUserId?s.content='<div class="hongbao__item fn__flex-inline" >\n    <div class="hongbao__finger_guessing">\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'0\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'1\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'2\');"></div>\n    </div>\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+p.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+p.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>':s.content='<div class="hongbao__item fn__flex-inline" onclick="'+a+'">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+p.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+p.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>'}}catch(e){}let t="",o="<a onclick=\"ChatRoom.shiled('"+s.userName+"')\" class=\"item\" style='color: red'>屏蔽Ta</a>\n";void 0!==s.userNickname&&""!==s.userNickname?s.userNickname=s.userNickname+" ("+s.userName+")":s.userNickname=s.userName,Label.currentUser===s.userName&&(t=" chats__item--me",o='<a onclick="ChatRoom.revoke('+s.oId+')" class="item">撤回</a>\n'),Label.level3Permitted&&(o='<a onclick="ChatRoom.revoke('+s.oId+')" class="item"><svg><use xlink:href="#administration"></use></svg> 撤回</a>\n');try{var m=s.content.replace("<p>","").replace("</p>",""),h=Util.parseDom(m);let t=!1,a="",n=0;for(let e=0;e<h.length;e++){var f=h.item(e);void 0!==f.src&&(t=!0,0!==n&&(a+=","),a+="'"+f.src+"'",n++)}t&&(o+='<a onclick="ChatRoom.addEmoji('+a+')" class="item">一键收藏表情</a>')}catch(e){}let n='<div class="fn-none">';if(n=(n+='<div id="chatroom'+s.oId+'" class="fn__flex chats__item'+t+'">\n    <a href="/member/'+s.userName+'" style="height: 38px">\n        <div class="avatar tooltipped__user" aria-label="'+s.userName+'" style="background-image: url(\''+s.userAvatarURL+'\');"></div>\n    </a>\n    <div class="chats__content">\n        <div class="chats__arrow"></div>\n')+('<div id="userName" class="ft__fade ft__smaller" style="padding-bottom: 3px;border-bottom: 1px solid #eee">\n    <span class="ft-gray">'+(null!=d?d+"-":"")+s.userNickname+"</span>&nbsp;\n"),void 0!==s.sysMetal&&""!==s.sysMetal){var v=JSON.parse(s.sysMetal).list;if(void 0!==v)for(let e=0;e<v.length;e++){var g=v[e];n+="<img title='"+g.name+" - "+g.description+"' src='"+Util.genMiniMetal(g.attr)+"'/>"}}if(n=(n+="</div>")+('        <div class="vditor-reset ft__smaller '+Label.chatRoomPictureStatus+'" style="margin-top: 3px">\n            '+ChatRoom.filterContent(s.content)+'\n        </div>\n        <div class="ft__smaller ft__fade fn__right date-bar">\n            '+s.time+'\n                <span class="fn__space5"></span>\n'),void 0!==s.client&&""!==s.client){var b=s.client.split("/")[0],k=s.client.split("/")[1];switch(b){case"Web":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-fish"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Bird":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-bird"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Dart":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-dart"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"ElvesOnline":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-moon"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Mobile":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-mobile"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Windows":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-windows"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Linux":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-linux"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IceNet":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-icenet"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Extension":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-extension"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Edge":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-edge"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Other":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-other"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"PC":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-pc2"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"iOS":case"macOS":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apple"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Android":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apk"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Chrome":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-chrome"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"VSCode":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-vscode"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IDEA":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-idea"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Python":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-python"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Golang":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+b+" "+k+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-golang"></use></svg></span>')+'<span class="fn__space5"></span>\n'}}if(e?n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+s.userName+"', '"+s.oId+'\', true)" class="item">@'+s.userName+"</a>\n                        <a onclick=\"ChatRoom.report('"+s.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n                    </details-menu>\n                </details>\n':n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+s.userName+"', '"+s.oId+'\', true)" class="item">@'+s.userName+"</a>\n                        <a onclick=\"ChatRoom.at('"+s.userName+"', '"+s.oId+'\', false)" class="item">引用</a>\n                        <a onclick="ChatRoom.repeat(\''+s.oId+'\')" class="item">复读机</a>\n                        <a onclick="ChatRoom.remark(\''+s.userOId+"', '"+s.userName+'\')" class="item">备注</a>\n                        <a onclick="ChatRoom.report(\''+s.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n'+o+"                    </details-menu>\n                </details>\n",n+="        </div>\n    </div>\n</div></div>",a){$("#chats").append(n);c=$("#chats>div.fn-none");c.show(),c.removeClass("fn-none")}else if(l){let t=++Label.plusN;1==t&&($("#chats").prepend("<div id='stacked' class='fn__flex' style='position:relative;display:none;'><span id='plusOne' onclick='ChatRoom.plusOne()' style='display:block;margin-left: 20px'><svg style='width: 30px; height: 20px; cursor: pointer;'><use xlink:href='#plusOneIcon'></use></svg></span></div>"),i=$("#chats>div.latest"),$("#stacked").prepend(i),i.find("#userName").show(),i.removeClass("latest"));let a=$("#stacked");1!=t&&a.fadeOut(100),setTimeout(function(){a.append(n),a.height(a.height()+27+"px");var e=$("#stacked>div.fn-none");e.show(),e.css("left",9*t+"px"),e.css("top",27*t+"px"),e.css("position","absolute"),e.find(".chats__content").css("background-color",t%2==0?"rgb(240 245 254)":"rgb(245 245 245)"),e.removeClass("fn-none"),a.fadeIn(200)},100)}else{$("#plusOne").remove(),s.md&&(Label.latestMessage=s.md,Label.plusN=0);r=$("#chats"),u=(r.find(".latest").removeClass("latest"),r.prepend(n),$("#chats>div.fn-none"));u.slideDown(200),u.addClass("latest"),u.removeClass("fn-none")}}}},imgViewer:null,imgWaitting:!1,imageViewer:function(){if(!this.imgViewer||$("div.vditor-reset.ft__smaller img:not(.ft__smaller,.emoji,.ext-emoji,*[src*='shield'],*[src*='/gen?'])").length!==this.imgViewer.length){this.imgViewer=this.imgViewer||new Viewer(document.querySelector("#chats"),{inline:!1,className:"PWLimgViwer",filter:e=>!e.parentElement.classList.contains("ft__smaller")&&!e.parentElement.classList.contains("ext-emoji")&&!e.classList.contains("emoji")&&e.src.indexOf("shield")<0&&e.src.indexOf("/gen?")<0,title(){let e=this.images[$(".PWLimgViwer .viewer-active").attr("data-index")];for(;!(e=e.parentElement).querySelector(".avatar"););return"From @"+e.querySelector(".avatar").getAttribute("aria-label")}});const e=function(){return setTimeout(()=>{ChatRoom.imgViewer.isShown?e():(ChatRoom.imgWaitting=!1,ChatRoom.imgViewer.update())},1e3),!0};this.imgWaitting=this.imgWaitting||e()}},addRobotMsg:function(e,t){$("#robotMsgList").prepend(e);$(".robot-msg-item")&&50<$(".robot-msg-item").length&&$(".robot-msg-item:gt(n-1)").remove()},changeCatchUser:function(e){var t;e&&0<e.length?(t='<div class="robot-msg-item"><div class="robot-msg-content">当前捕获用户:'+e+"</div></div></div>",$("#robotMsgList").prepend(t)):$("#robotMsgList").prepend('<div class="robot-msg-item"><div class="robot-msg-content">当前不存在需要捕获的用户</div></div></div>'),window.localStorage.robot_list=e,catchUsers=e.split(",")},initCatchUser:function(){$("#robotBtn").click(function(){$("#robotBox").show(200),$("#robotBtn").hide(200),setTimeout(()=>{$("#robotBox").addClass("robot-active"),$("#robotBox").attr("style","height:"+(window.innerHeight-25-58)+"px"),$("#robotMsgList").attr("style","height:"+(window.innerHeight-85-58)+"px")},220)}),$("#robotClose").click(function(){var e=$("#robotBox");setTimeout(()=>{$(".robot-chat-input").val(""),$("#robotBox").hide(200),$("#robotBtn").show(200)},e.hasClass("robot-active")?420:1),e.removeClass("robot-active"),e.css("height","")}),$("#robotMinimize").click(function(){$("#robotBox").toggleClass("robot-active")}),$("#clearRobotMsg").click(function(){$(".robot-msg-item").remove()}),$("#catch-word").click(function(){window.localStorage["catch-word-flag"]=$("#catch-word").prop("checked")}),$("#changeCatchUsers").click(function(){Util.alert('<div class="form fn__flex-column">\n<label>\n  <div class="ft__smaller" style="float: left">将捕获的用户id填写到下方输入框；<br>多个用户id的情况用英文逗号隔开。</div>\n  <div class="fn-hr5 fn__5"></div>\n  <input type="text" id="robot-catch-user">\n</label>\n<div class="fn-hr5"></div>\n<div class="fn__flex" style="margin-top: 15px; justify-content: flex-end;">\n  <button class="btn btn--confirm" onclick=\'ChatRoom.changeCatchUser($("#robot-catch-user").val());Util.closeAlert();\'>确认</button>\n</div>\n</div>',"编辑捕获用户列表"),$("#robot-catch-user").val(window.localStorage.robot_list||"")});var e=window.localStorage.robot_list||"";ChatRoom.changeCatchUser(e);let t=!1;"true"===window.localStorage["catch-word-flag"]&&(t=!0),$("#catch-word").prop("checked",t)},loadAvatarPendant:function(){var e=(new Date).getFullYear(),t=(t=((new Date).getMonth()+1).toString())[1]?t:"0"+t,a=(new Date).getDate(),n=e+`-${t}-`+a,o={2022:["2022-01-31","2022-02-06"],2023:["2023-01-21","2023-01-27"],2024:["2024-02-09","2024-02-15"],2025:["2025-01-28","2025-02-03"],2026:["2026-02-16","2026-02-22"],2027:["2027-02-06","2027-02-12"]},s={2022:["2022-09-10","2022-09-12"],2023:["2023-09-29","2023-10-01"],2024:["2024-09-17","2024-09-19"],2025:["2025-10-06","2025-10-09"],2026:["2026-09-25","2026-09-27"],2027:["2027-09-15","2027-09-17"]},i=document.querySelector("body");10==t&&a<=7?i.classList.add("NationalDay"):12==t&&24<=a&&12==t&&a<=25?i.classList.add("Christmas"):(t=new Date(n).getTime(),new Date(s[e][0]).getTime()<=t&&new Date(s[e][1]).getTime()>=t?i.classList.add("MidAutumnFestival"):new Date(o[e][0]).getTime()<=t&&new Date(o[e][1]).getTime()>=t&&i.classList.add("SpringFestival"))},isMobile:function(){for(var e=navigator.userAgent,t=["Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"],a=!1,n=0;n<t.length;n++)if(0<e.indexOf(t[n])){a=!0;break}var o=window.screen.width,s=window.screen.height;return a=325<o&&s<750?!0:a}});