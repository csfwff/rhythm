...
> ${t}</span>
`,!1)}$(window).scrollTop(0)},renderRedPacket:function(i,e,t,a,n,s){let l=!1,r=-1,c,o;if(void 0!==n&&(c=n.winnerResult,o=n.diceParticles),e===t)for(let e=0;e<i.length;e++){var d=i[e];d.userMoney>r&&(r=d.userMoney)}for(let o=0;o<i.length;o++){var u=i[o],p=u.userMoney,m=u.dice,v=u.userName;v===Label.currentUser&&(void 0!==p?0<p?$("#redPacketIGot").text("抢到了 "+p+" 积分"):0==p?$("#redPacketIGot").text("恭喜你，抢了个寂寞"):$("#redPacketIGot").text("什么运气，你竟然被反向抢红包了"):void 0!==m&&$("#redPacketIGot").text("押注 "+m.chips+" 积分"),l=!0);let e="",t=v;switch(e=void 0!==m?m.bet:e){case"big":t=v+" (押大)";break;case"small":t=v+" (押小)";break;case"leopard":t=v+" (豹子)"}var h=u.time;let a="",n=`<li class="fn__flex menu__item">${a=void 0!==u.avatar?`<img class="avatar avatar--mid" style="margin-right: 10px; background-image: none; background-color: transparent;" src="${u.avatar}">`:a}
<div class="fn__flex-1" style="text-align: left !important;">
<h2 class="list__user"><a href="${Label.servePath}/member/${v}">${t}</a>
</h2>`;0<p&&p===r?(r=-1,n+="<span class='green small btn'>来自老王的认可</span><br>\n"):0===p?n+="<span class='red small btn'>0溢事件</span><br>\n":p<0&&(n+="<span class='yellow small btn'>抢红包有风险</span><br>\n"),void 0!==c&&(c===m.bet?n+="<span class='green small btn'>运气好而已</span><br>\n":n+="<span class='red small btn'>别玩了</span><br>\n");let s;s=void 0===p&&void 0!==m?m.chips:p,n+=`<span class="ft__fade ft__smaller">${h}</span>
    </div>
...
</div>`,"出拳")},unpackRedPacket:function(a,e){null==e&&(e="0"),$.ajax({url:Label.servePath+"/chat-room/red-packet/open",method:"POST",data:JSON.stringify({oId:a,gesture:e,dice:{bet:$("#betRadio>input[name=bet]:checked").val(),chips:$("#betRadio>input[name=chips]").val()}}),success:function(t){if(-1!==t.code){let e="";void 0!==t.info.gesture&&(e=(Label.currentUser===t.info.userName?"你":t.info.userName)+"出拳:  "+["石头","剪刀","布"][t.info.gesture]),Util.alert(`<style>.dialog-header-bg {border-radius: 4px 4px 0 0; background-color: rgb(210, 63, 49); color: rgb(255, 255, 255);}.dialog-main {height: 456px;overflow: auto;}</style><div class="fn-hr5"></div>
<div class="ft__center">
...
</ul></div>`,"红包"),ChatRoom.renderRedPacket(t.who,t.info.count,t.info.got,t.recivers,t.diceRet,t.info.userName),t.info.count===t.info.got&&($("#chatroom"+a).find(".hongbao__item").css("opacity",".36").attr("onclick","ChatRoom.unpackRedPacket("+a+")"),!0===t.dice?$("#chatroom"+a).find(".redPacketDesc").html("已开盘"):$("#chatroom"+a).find(".redPacketDesc").html("已经被抢光啦"))}else Util.alert(t.msg)},error:function(e){Util.alert(e.msg)}})},plusOne:function(){ChatRoom.editor.setValue(Label.latestMessage),ChatRoom.send()},renderMsg:function(o,i){if(!(0<ChatRoom.shileds.indexOf(o.userName))){let e=!1;var a=Label.latestMessage===o.md;try{var l=$.parseJSON(o.content.replace("<p>","").replace("</p>",""));if("redPacket"===l.msgType){e=!0;let t="未知类型红包",a="ChatRoom.unpackRedPacket('"+o.oId+"')";switch(l.type){case"random":t="拼手气红包";break;case"average":t="普通红包";break;case"specify":t="专属红包";break;case"heartbeat":t="心跳红包 (慎抢)";break;case"rockPaperScissors":t="石头剪刀布红包",l.senderId!=Label.currentUserId&&(a="");break;case"dice":if(t="摇骰子",l.senderId!==Label.currentUserId){let e=!1;for(idx in l.who)if(l.who[idx].userId===Label.currentUserId){e=!0;break}e||(a="ChatRoom.bet('"+o.oId+"')")}}if(Number(l.count)===Number(l.got)){let e="已经被抢光啦";"dice"===l.type&&(e="已开盘"),o.content='<div style="opacity: .36;" class="hongbao__item fn__flex-inline" onclick="ChatRoom.unpackRedPacket(\''+o.oId+'\')">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+l.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+l.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n'+e+"\n        </div>\n    </div>\n</div>"}else"rockPaperScissors"===l.type&&l.senderId!=Label.currentUserId?o.content='<div class="hongbao__item fn__flex-inline" onclick="'+a+'">\n    <div class="hongbao__finger_guessing">\n        <div class="hongbao__finger_guessing_icon" onclick="ChatRoom.unpackRedPacket('+o.oId+',\'0\');Util.clearAlert()"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="ChatRoom.unpackRedPacket('+o.oId+',\'1\');Util.clearAlert()"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="ChatRoom.unpackRedPacket('+o.oId+',\'2\');Util.clearAlert()"></div>\n    </div>\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+l.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+l.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>':o.content='<div class="hongbao__item fn__flex-inline" onclick="'+a+'">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+l.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+l.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>'}}catch(e){}let t="",s="<a onclick=\"ChatRoom.shiled('"+o.userName+"')\" class=\"item\" style='color: red'>屏蔽Ta</a>\n";void 0!==o.userNickname&&""!==o.userNickname?o.userNickname=o.userNickname+" ("+o.userName+")":o.userNickname=o.userName,Label.currentUser===o.userName&&(t=" chats__item--me",s='<a onclick="ChatRoom.revoke('+o.oId+')" class="item">撤回</a>\n'),Label.level3Permitted&&(s='<a onclick="ChatRoom.revoke('+o.oId+')" class="item"><svg><use xlink:href="#administration"></use></svg> 撤回</a>\n');try{var r=o.content.replace("<p>","").replace("</p>",""),c=Util.parseDom(r);let t=!1,a="",n=0;for(let e=0;e<c.length;e++){var d=c.item(e);void 0!==d.src&&(t=!0,0!==n&&(a+=","),a+="'"+d.src+"'",n++)}t&&(s+='<a onclick="ChatRoom.addEmoji('+a+')" class="item">一键收藏表情</a>')}catch(e){}let n='<div class="fn-none">';if(n=(n+='<div id="chatroom'+o.oId+'" class="fn__flex chats__item'+t+'">\n    <a href="/member/'+o.userName+'" style="height: 38px">\n        <div class="avatar tooltipped__user" aria-label="'+o.userName+'" style="background-image: url(\''+o.userAvatarURL+'\');"></div>\n    </a>\n    <div class="chats__content">\n        <div class="chats__arrow"></div>\n')+('<div id="userName" class="ft__fade ft__smaller" style="padding-bottom: 3px;border-bottom: 1px solid #eee">\n    <span class="ft-gray">'+o.userNickname+"</span>&nbsp;\n"),void 0!==o.sysMetal&&""!==o.sysMetal){var u=JSON.parse(o.sysMetal).list;if(void 0!==u)for(let e=0;e<u.length;e++){var p=u[e];n+="<img title='"+p.name+" - "+p.description+"' src='"+Util.genMiniMetal(p.attr)+"'/>"}}if(n=(n+="</div>")+('        <div class="vditor-reset ft__smaller '+Label.chatRoomPictureStatus+'" style="margin-top: 3px">\n            '+o.content+'\n        </div>\n        <div class="ft__smaller ft__fade fn__right date-bar">\n            '+o.time+'\n                <span class="fn__space5"></span>\n'),void 0!==o.client&&""!==o.client){var m=o.client.split("/")[0],v=o.client.split("/")[1];switch(m){case"Web":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-fish"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"ElvesOnline":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-moon"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Mobile":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-mobile"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Windows":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-windows"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Linux":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-linux"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IceNet":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-icenet"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Extension":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-extension"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Edge":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-edge"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Other":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-other"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"PC":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-pc2"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"iOS":case"macOS":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apple"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Android":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apk"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Chrome":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-chrome"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"VSCode":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-vscode"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IDEA":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-idea"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Python":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-python"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Golang":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+v+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-golang"></use></svg></span>')+'<span class="fn__space5"></span>\n'}}if(e?n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+o.userName+"', '"+o.oId+'\', true)" class="item">@'+o.userName+"</a>\n                        <a onclick=\"ChatRoom.report('"+o.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n                    </details-menu>\n                </details>\n':n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+o.userName+"', '"+o.oId+'\', true)" class="item">@'+o.userName+"</a>\n                        <a onclick=\"ChatRoom.at('"+o.userName+"', '"+o.oId+'\', false)" class="item">引用</a>\n                        <a onclick="ChatRoom.repeat(\''+o.oId+'\')" class="item">复读机</a>\n                        <a onclick="ChatRoom.report(\''+o.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n'+s+"                    </details-menu>\n                </details>\n",n+="        </div>\n    </div>\n</div></div>",i){$("#chats").append(n);r=$("#chats>div.fn-none");r.show(),r.removeClass("fn-none")}else if(a){let t=++Label.plusN;1==t&&($("#chats").prepend("<div id='stacked' class='fn__flex' style='position:relative;display:none;'><span id='plusOne' onclick='ChatRoom.plusOne()' style='display:block;margin-left: 20px'><svg style='width: 30px; height: 20px; cursor: pointer;'><use xlink:href='#plusOneIcon'></use></svg></span></div>"),i=$("#chats>div.latest"),$("#stacked").prepend(i),i.find("#userName").show(),i.removeClass("latest"));let a=$("#stacked");1!=t&&a.fadeOut(100),setTimeout(function(){a.append(n),a.height(a.height()+27+"px");var e=$("#stacked>div.fn-none");e.show(),e.css("left",9*t+"px"),e.css("top",27*t+"px"),e.css("position","absolute"),e.find(".chats__content").css("background-color",t%2==0?"rgb(240 245 254)":"rgb(245 245 245)"),e.removeClass("fn-none"),a.fadeIn(200)},100)}else{$("#plusOne").remove(),o.md&&(Label.latestMessage=o.md,Label.plusN=0);r=$("#chats"),a=(r.find(".latest").removeClass("latest"),r.prepend(n),$("#chats>div.fn-none"));a.slideDown(200),a.addClass("latest"),a.removeClass("fn-none")}}},imgViewer:null,imgWaitting:!1,imageViewer:function(){if(!this.imgViewer||$("div.vditor-reset.ft__smaller img:not(.ft__smaller,.emoji,.ext-emoji,*[src*='shield'],*[src*='/gen?'])").length!==this.imgViewer.length){this.imgViewer=this.imgViewer||new Viewer(document.querySelector("#chats"),{inline:!1,className:"PWLimgViwer",filter:e=>!e.parentElement.classList.contains("ft__smaller")&&!e.parentElement.classList.contains("ext-emoji")&&!e.classList.contains("emoji")&&e.src.indexOf("shield")<0&&e.src.indexOf("/gen?")<0,title(){let e=this.images[$(".PWLimgViwer .viewer-active").attr("data-index")];for(;!(e=e.parentElement).querySelector(".avatar"););return"From @"+e.querySelector(".avatar").getAttribute("aria-label")}});const e=function(){return setTimeout(()=>{ChatRoom.imgViewer.isShown?e():(ChatRoom.imgWaitting=!1,ChatRoom.imgViewer.update())},1e3),!0};this.imgWaitting=this.imgWaitting||e()}},iceWs:"",IceGameCK:localStorage.getItem("IceGameCK")||null,loadXiaoIceGame:function(){iceWs=new WebSocket("wss://game.yuis.cc/wss");let e;iceWs.onopen=function(){iceWs.send(JSON.stringify({type:"setUser",user:Label.currentUser,ck:ChatRoom.IceGameCK,uid:Label.currentUserId})),e=setInterval(()=>{iceWs.send(JSON.stringify({type:"hb"}))},15e3)},iceWs.onclose=function(){$("#iceMsgList").prepend(`<div class="ice-msg-item">
