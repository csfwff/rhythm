...
</ul></div>`,"红包"),ChatRoom.renderRedPacket(t.who,t.info.count,t.info.got,t.recivers,t.diceRet,t.info.userName),t.info.count===t.info.got&&($("#chatroom"+a).find(".hongbao__item").css("opacity",".36").attr("onclick","ChatRoom.unpackRedPacket("+a+")"),$("#chatroom"+a).find(".hongbao__item").hasClass("opened")||$("#chatroom"+a).find(".hongbao__item").addClass("opened"),!0===t.dice?$("#chatroom"+a).find(".redPacketDesc").html("已开盘"):$("#chatroom"+a).find(".redPacketDesc").html("已经被抢光啦"))}else Util.alert(t.msg)},error:function(e){Util.alert(e.msg)}})},plusOne:function(){ChatRoom.editor.setValue(Label.latestMessage),ChatRoom.send()},renderMsg:function(s,i){if(!(0<ChatRoom.shileds.indexOf(s.userName))){let e=!1;var a=Label.latestMessage===s.md;try{var l=$.parseJSON(s.content.replace("<p>","").replace("</p>",""));if("redPacket"===l.msgType){e=!0;let t="未知类型红包",a="ChatRoom.unpackRedPacket('"+s.oId+"')";switch(l.type){case"random":t="拼手气红包";break;case"average":t="普通红包";break;case"specify":t="专属红包";break;case"heartbeat":t="心跳红包 (慎抢)";break;case"rockPaperScissors":t="石头剪刀布红包",l.senderId!=Label.currentUserId&&(a="");break;case"dice":if(t="摇骰子",l.senderId!==Label.currentUserId){let e=!1;for(idx in l.who)if(l.who[idx].userId===Label.currentUserId){e=!0;break}e||(a="ChatRoom.bet('"+s.oId+"')")}}if(Number(l.count)===Number(l.got)){let e="已经被抢光啦";"dice"===l.type&&(e="已开盘"),s.content='<div style="opacity: .36;" class="hongbao__item fn__flex-inline" onclick="ChatRoom.unpackRedPacket(\''+s.oId+'\')">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+l.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+l.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n'+e+"\n        </div>\n    </div>\n</div>"}else"rockPaperScissors"===l.type&&l.senderId!=Label.currentUserId?s.content='<div class="hongbao__item fn__flex-inline" >\n    <div class="hongbao__finger_guessing">\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'0\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'1\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'2\');"></div>\n    </div>\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+l.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+l.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>':s.content='<div class="hongbao__item fn__flex-inline" onclick="'+a+'">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+l.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+l.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>'}}catch(e){}let t="",o="<a onclick=\"ChatRoom.shiled('"+s.userName+"')\" class=\"item\" style='color: red'>屏蔽Ta</a>\n";void 0!==s.userNickname&&""!==s.userNickname?s.userNickname=s.userNickname+" ("+s.userName+")":s.userNickname=s.userName,Label.currentUser===s.userName&&(t=" chats__item--me",o='<a onclick="ChatRoom.revoke('+s.oId+')" class="item">撤回</a>\n'),Label.level3Permitted&&(o='<a onclick="ChatRoom.revoke('+s.oId+')" class="item"><svg><use xlink:href="#administration"></use></svg> 撤回</a>\n');try{var r=s.content.replace("<p>","").replace("</p>",""),c=Util.parseDom(r);let t=!1,a="",n=0;for(let e=0;e<c.length;e++){var d=c.item(e);void 0!==d.src&&(t=!0,0!==n&&(a+=","),a+="'"+d.src+"'",n++)}t&&(o+='<a onclick="ChatRoom.addEmoji('+a+')" class="item">一键收藏表情</a>')}catch(e){}let n='<div class="fn-none">';if(n=(n+='<div id="chatroom'+s.oId+'" class="fn__flex chats__item'+t+'">\n    <a href="/member/'+s.userName+'" style="height: 38px">\n        <div class="avatar tooltipped__user" aria-label="'+s.userName+'" style="background-image: url(\''+s.userAvatarURL+'\');"></div>\n    </a>\n    <div class="chats__content">\n        <div class="chats__arrow"></div>\n')+('<div id="userName" class="ft__fade ft__smaller" style="padding-bottom: 3px;border-bottom: 1px solid #eee">\n    <span class="ft-gray">'+s.userNickname+"</span>&nbsp;\n"),void 0!==s.sysMetal&&""!==s.sysMetal){var u=JSON.parse(s.sysMetal).list;if(void 0!==u)for(let e=0;e<u.length;e++){var p=u[e];n+="<img title='"+p.name+" - "+p.description+"' src='"+Util.genMiniMetal(p.attr)+"'/>"}}if(n=(n+="</div>")+('        <div class="vditor-reset ft__smaller '+Label.chatRoomPictureStatus+'" style="margin-top: 3px">\n            '+s.content+'\n        </div>\n        <div class="ft__smaller ft__fade fn__right date-bar">\n            '+s.time+'\n                <span class="fn__space5"></span>\n'),void 0!==s.client&&""!==s.client){var m=s.client.split("/")[0],h=s.client.split("/")[1];switch(m){case"Web":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-fish"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Bird":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-bird"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Dart":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-dart"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"ElvesOnline":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-moon"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Mobile":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-mobile"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Windows":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-windows"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Linux":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-linux"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IceNet":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-icenet"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Extension":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-extension"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Edge":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-edge"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Other":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-other"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"PC":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-pc2"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"iOS":case"macOS":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apple"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Android":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apk"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Chrome":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-chrome"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"VSCode":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-vscode"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IDEA":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-idea"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Python":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-python"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Golang":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+m+" "+h+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-golang"></use></svg></span>')+'<span class="fn__space5"></span>\n'}}if(e?n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+s.userName+"', '"+s.oId+'\', true)" class="item">@'+s.userName+"</a>\n                        <a onclick=\"ChatRoom.report('"+s.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n                    </details-menu>\n                </details>\n':n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+s.userName+"', '"+s.oId+'\', true)" class="item">@'+s.userName+"</a>\n                        <a onclick=\"ChatRoom.at('"+s.userName+"', '"+s.oId+'\', false)" class="item">引用</a>\n                        <a onclick="ChatRoom.repeat(\''+s.oId+'\')" class="item">复读机</a>\n                        <a onclick="ChatRoom.report(\''+s.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n'+o+"                    </details-menu>\n                </details>\n",n+="        </div>\n    </div>\n</div></div>",i){$("#chats").append(n);r=$("#chats>div.fn-none");r.show(),r.removeClass("fn-none")}else if(a){let t=++Label.plusN;1==t&&($("#chats").prepend("<div id='stacked' class='fn__flex' style='position:relative;display:none;'><span id='plusOne' onclick='ChatRoom.plusOne()' style='display:block;margin-left: 20px'><svg style='width: 30px; height: 20px; cursor: pointer;'><use xlink:href='#plusOneIcon'></use></svg></span></div>"),i=$("#chats>div.latest"),$("#stacked").prepend(i),i.find("#userName").show(),i.removeClass("latest"));let a=$("#stacked");1!=t&&a.fadeOut(100),setTimeout(function(){a.append(n),a.height(a.height()+27+"px");var e=$("#stacked>div.fn-none");e.show(),e.css("left",9*t+"px"),e.css("top",27*t+"px"),e.css("position","absolute"),e.find(".chats__content").css("background-color",t%2==0?"rgb(240 245 254)":"rgb(245 245 245)"),e.removeClass("fn-none"),a.fadeIn(200)},100)}else{$("#plusOne").remove(),s.md&&(Label.latestMessage=s.md,Label.plusN=0);r=$("#chats"),a=(r.find(".latest").removeClass("latest"),r.prepend(n),$("#chats>div.fn-none"));a.slideDown(200),a.addClass("latest"),a.removeClass("fn-none")}}},imgViewer:null,imgWaitting:!1,imageViewer:function(){if(!this.imgViewer||$("div.vditor-reset.ft__smaller img:not(.ft__smaller,.emoji,.ext-emoji,*[src*='shield'],*[src*='/gen?'])").length!==this.imgViewer.length){this.imgViewer=this.imgViewer||new Viewer(document.querySelector("#chats"),{inline:!1,className:"PWLimgViwer",filter:e=>!e.parentElement.classList.contains("ft__smaller")&&!e.parentElement.classList.contains("ext-emoji")&&!e.classList.contains("emoji")&&e.src.indexOf("shield")<0&&e.src.indexOf("/gen?")<0,title(){let e=this.images[$(".PWLimgViwer .viewer-active").attr("data-index")];for(;!(e=e.parentElement).querySelector(".avatar"););return"From @"+e.querySelector(".avatar").getAttribute("aria-label")}});const e=function(){return setTimeout(()=>{ChatRoom.imgViewer.isShown?e():(ChatRoom.imgWaitting=!1,ChatRoom.imgViewer.update())},1e3),!0};this.imgWaitting=this.imgWaitting||e()}},iceWs:"",IceGameCK:localStorage.getItem("IceGameCK")||null,loadXiaoIceGame:function(){iceWs=new WebSocket("wss://game.yuis.cc/wss");let e;iceWs.onopen=function(){iceWs.send(JSON.stringify({type:"setUser",user:Label.currentUser,ck:ChatRoom.IceGameCK,uid:Label.currentUserId})),e=setInterval(()=>{iceWs.send(JSON.stringify({type:"hb"}))},15e3)},iceWs.onclose=function(){$("#iceMsgList").prepend(`<div class="ice-msg-item">
