...
<div class="list"><ul id="redPacketList">
                  ...
                  </div>`;$("#iceMsgList").prepend(t);let a="gameMsg";console.log(/(登录)/.test(e)),/(登录)/.test(e)&&(a="login"),iceWs.send(JSON.stringify({type:a,ck:ChatRoom.IceGameCK,msg:e}))},loadAvatarPendant:function(){var e=(new Date).getFullYear();let t=((new Date).getMonth()+1).toString();t=t[1]?t:"0"+t;var a=(new Date).getDate(),n=`${e}-${t}-`+a,o={2022:["2022-01-31","2022-02-06"],2023:["2023-01-21","2023-01-27"],2024:["2024-02-09","2024-02-15"],2025:["2025-01-28","2025-02-03"],2026:["2026-02-16","2026-02-22"],2027:["2027-02-06","2027-02-12"]},s={2022:["2022-09-10","2022-09-12"],2023:["2023-09-29","2023-10-01"],2024:["2024-09-17","2024-09-19"],2025:["2025-10-06","2025-10-09"],2026:["2026-09-25","2026-09-27"],2027:["2027-09-15","2027-09-17"]};let i=document.querySelector("body");10===t&&a<=7?i.classList.add("NationalDay"):12===t&&24<=a&&12===t&&a<=25?i.classList.add("Christmas"):(n=new Date(n).getTime(),new Date(s[e][0]).getTime()<=n&&new Date(s[e][1]).getTime()>=n?i.classList.add("MidAutumnFestival"):new Date(o[e][0]).getTime()<=n&&new Date(o[e][1]).getTime()>=n&&i.classList.add("SpringFestival"))}};