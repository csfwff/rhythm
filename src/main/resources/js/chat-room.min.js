...
> ${t}</span>
`,!1)}$(window).scrollTop(0)},remarkList:{},remark:function(e,t){console.log(e,t);t=prompt(`要给 ${t} 备注什么呢?`);console.log(t),null!==t&&(""===t?delete ChatRoom.remarkList[e]:ChatRoom.remarkList[e]=t,localStorage.setItem("user_remark",JSON.stringify(ChatRoom.remarkList)))},filterContent:function(e){var t=document.createElement("div");return t.innerHTML=e,t.querySelectorAll("img").forEach(e=>{e.setAttribute("originalsrc",e.src),e.src.startsWith("https://file.fishpi.cn")&&(e.src=e.src.split("?")[0]+"?imageView2/0/w/150/h/150/interlace/0/q/90")}),t.innerHTML},renderRedPacket:function(i,e,t,a,o,n){let r=!1,l=-1,c,s;if(void 0!==o&&(c=o.winnerResult,s=o.diceParticles),e===t)for(let e=0;e<i.length;e++){var d=i[e];d.userMoney>l&&(l=d.userMoney)}for(let s=0;s<i.length;s++){var p=i[s],u=p.userMoney,m=p.dice,h=p.userName;h===Label.currentUser&&(void 0!==u?0<u?$("#redPacketIGot").text("抢到了 "+u+" 积分"):0==u?$("#redPacketIGot").text("恭喜你，抢了个寂寞"):$("#redPacketIGot").text("什么运气，你竟然被反向抢红包了"):void 0!==m&&$("#redPacketIGot").text("押注 "+m.chips+" 积分"),r=!0);let e="",t=h;switch(e=void 0!==m?m.bet:e){case"big":t=h+" (押大)";break;case"small":t=h+" (押小)";break;case"leopard":t=h+" (豹子)"}var f=p.time;let a="",o=`<li class="fn__flex menu__item">${a=void 0!==p.avatar?`<img class="avatar avatar--mid" style="margin-right: 10px; background-image: none; background-color: transparent;" src="${p.avatar}">`:a}
<div class="fn__flex-1" style="text-align: left !important;">
<h2 class="list__user"><a href="${Label.servePath}/member/${h}">${t}</a>
</h2>`;0<u&&u===l?(l=-1,o+="<span class='green small btn'>来自老王的认可</span><br>\n"):0===u?o+="<span class='red small btn'>0溢事件</span><br>\n":u<0&&(o+="<span class='yellow small btn'>抢红包有风险</span><br>\n"),void 0!==c&&(c===m.bet?o+="<span class='green small btn'>运气好而已</span><br>\n":o+="<span class='red small btn'>别玩了</span><br>\n");let n;n=void 0===u&&void 0!==m?m.chips:u,o+=`<span class="ft__fade ft__smaller">${f}</span>
    </div>
    <div class="fn__flex-center">${n} 积分</div>
</li>
`,$("#redPacketList").append(o)}if(r||$("#redPacketIGot").text(Label.currentUser===n?"金主来了":"你错过了这个红包"),void 0!==a&&0<a.length&&-1===(index=a.indexOf(Label.currentUser))&&($("#msg").text("这个红包属于 "+a),$("#redPacketIGot").text(Label.currentUser===n?"金主来了":"这个红包不属于你")),void 0!==c){let e=" ",t=0;for(key in s)t+=s[key];switch(c){case"big":e+=t+"点大";break;case"small":e+=t+"点小";break;case"leopard":e+="豹子通杀"}$("#redPacketIGot").text(s+e)}},bet:function(e){Util.alert('<div class="form fn__flex-column">\n<label id="betRadio">\n  <input type="radio" name="bet" value="big" checked>大\n  <input type="radio" name="bet" value="small">小\n  <input type="radio" name="bet" value="leopard">豹子\n  <div class="ft__smaller ft__fade" style="float: left">筹码</div>\n  <div class="fn-hr5 fn__5"></div>\n  <input type="number" min="32" max="100" required="" value="32" id="chipsLabel" name=\'chips\' onkeypress="return(/[\\d]/.test(String.fromCharCode(event.keyCode)))">\n</label>\n<div class="fn__flex" style="margin-top: 15px">\n  <button class="btn btn--confirm" onclick="ChatRoom.unpackRedPacket('+e+');Util.clearAlert()">押注</button>\n</div>\n</div>',"买定离手"),$("#chipsLabel").on("change",function(){100<$("#chipsLabel").val()&&$("#chipsLabel").val("100"),$("#chipsLabel").val()<=32&&$("#chipsLabel").val("32")})},selectGesture:function(e){Util.alert(`<div class="form fn__flex-column select-center">
<div>
...
</ul></div>`,"红包"),ChatRoom.renderRedPacket(t.who,t.info.count,t.info.got,t.recivers,t.diceRet,t.info.userName),t.info.count===t.info.got&&($("#chatroom"+a).find(".hongbao__item").css("opacity",".36").attr("onclick","ChatRoom.unpackRedPacket("+a+")"),$("#chatroom"+a).find(".hongbao__item").hasClass("opened")||$("#chatroom"+a).find(".hongbao__item").addClass("opened"),!0===t.dice?$("#chatroom"+a).find(".redPacketDesc").html("已开盘"):$("#chatroom"+a).find(".redPacketDesc").html("已经被抢光啦"))}else Util.alert(t.msg)},error:function(e){Util.alert(e.msg)}})},plusOne:function(){ChatRoom.editor.setValue(Label.latestMessage),ChatRoom.send()},renderMsg:function(s,i){if(!(0<ChatRoom.shileds.indexOf(s.userName))){var r=s.userName,l=s.content,c=s.md||"",d=s.userAvatarURL,p=ChatRoom.remarkList[s.userOId];if(!i&&catchUsers.includes(r)&&-1==l.indexOf('"msgType":"redPacket"')){var u='<div class="robot-msg-item"><div class="avatar" style="background-image: url('+d+')"></div><div class="robot-msg-content"><div class="robot-username"><p>'+r+"</p></div> "+l+' <div class="fn__right" style="margin-top: 5px; font-size: 10px;">'+s.time+"</div></div></div>";ChatRoom.addRobotMsg(u)}else if(!i&&$("#catch-word").prop("checked")&&-1==l.indexOf('"msgType":"redPacket"')&&(c.startsWith("鸽 ")||c.startsWith("小冰 ")||c.startsWith("凌 ")||c.startsWith("ida "))){u='<div class="robot-msg-item"><div class="avatar" style="background-image: url('+d+')"></div><div class="robot-msg-content"><div class="robot-username"><p>'+r+"</p></div> "+l+' <div class="fn__right" style="margin-top: 5px; font-size: 10px;">'+s.time+"</div></div></div>";ChatRoom.addRobotMsg(u)}else{let e=!1,t=!1;c=Label.latestMessage===s.md;try{var m=$.parseJSON(s.content.replace("<p>","").replace("</p>",""));if("redPacket"===m.msgType){e=!0;let t="未知类型红包",a="ChatRoom.unpackRedPacket('"+s.oId+"')";switch(m.type){case"random":t="拼手气红包";break;case"average":t="普通红包";break;case"specify":t="专属红包";break;case"heartbeat":t="心跳红包 (慎抢)";break;case"rockPaperScissors":t="石头剪刀布红包",m.senderId!=Label.currentUserId&&(a="");break;case"dice":if(t="摇骰子",m.senderId!==Label.currentUserId){let e=!1;for(idx in m.who)if(m.who[idx].userId===Label.currentUserId){e=!0;break}e||(a="ChatRoom.bet('"+s.oId+"')")}}if(Number(m.count)===Number(m.got)){let e="已经被抢光啦";"dice"===m.type&&(e="已开盘"),s.content='<div style="opacity: .36;" class="hongbao__item fn__flex-inline" onclick="ChatRoom.unpackRedPacket(\''+s.oId+'\')">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+m.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+m.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n'+e+"\n        </div>\n    </div>\n</div>"}else"rockPaperScissors"===m.type&&m.senderId!=Label.currentUserId?s.content='<div class="hongbao__item fn__flex-inline" >\n    <div class="hongbao__finger_guessing">\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'0\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'1\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+s.oId+',\'2\');"></div>\n    </div>\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+m.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+m.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>':s.content='<div class="hongbao__item fn__flex-inline" onclick="'+a+'">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+m.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+m.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>'}else"weather"===m.type&&(t=!0,s.content='<div id="weather_'+s.oId+'" style="width: 300px;height:280px;" data-date="'+m.date+'" data-code="'+m.weatherCode+'" data-max="'+m.max+'" data-min="'+m.min+'" data-t="'+m.t+'" data-st="'+m.st+'"></div>')}catch(e){}let a="",n="<a onclick=\"ChatRoom.shiled('"+s.userName+"')\" class=\"item\" style='color: red'>屏蔽Ta</a>\n";void 0!==s.userNickname&&""!==s.userNickname?s.userNickname=s.userNickname+" ("+s.userName+")":s.userNickname=s.userName,Label.currentUser===s.userName&&(a=" chats__item--me",n='<a onclick="ChatRoom.revoke('+s.oId+')" class="item">撤回</a>\n'),Label.level3Permitted&&(n='<a onclick="ChatRoom.revoke('+s.oId+')" class="item"><svg><use xlink:href="#administration"></use></svg> 撤回</a>\n');try{var h=s.content.replace("<p>","").replace("</p>",""),f=Util.parseDom(h);let t=!1,a="",o=0;for(let e=0;e<f.length;e++){var v=f.item(e);void 0!==v.src&&(t=!0,0!==o&&(a+=","),a+="'"+v.src+"'",o++)}t&&(n+='<a onclick="ChatRoom.addEmoji('+a+')" class="item">一键收藏表情</a>')}catch(e){}let o='<div class="fn-none">';if(o=(o+='<div id="chatroom'+s.oId+'" class="fn__flex chats__item'+a+'">\n    <a href="/member/'+s.userName+'" style="height: 38px">\n        <div class="avatar tooltipped__user" aria-label="'+s.userName+'" style="background-image: url(\''+s.userAvatarURL+'\');"></div>\n    </a>\n    <div class="chats__content">\n        <div class="chats__arrow"></div>\n')+('<div id="userName" class="ft__fade ft__smaller" style="padding-bottom: 3px;border-bottom: 1px solid #eee">\n    <span class="ft-gray">'+(null!=p?p+"-":"")+s.userNickname+"</span>&nbsp;\n"),void 0!==s.sysMetal&&""!==s.sysMetal){var g=JSON.parse(s.sysMetal).list;if(void 0!==g)for(let e=0;e<g.length;e++){var b=g[e];o+="<img title='"+b.name+" - "+b.description+"' src='"+Util.genMiniMetal(b.attr)+"'/>"}}if(o=(o+="</div>")+('        <div class="vditor-reset ft__smaller '+Label.chatRoomPictureStatus+'" style="margin-top: 3px">\n            '+ChatRoom.filterContent(s.content)+'\n        </div>\n        <div class="ft__smaller ft__fade fn__right date-bar">\n            '+s.time+'\n                <span class="fn__space5"></span>\n'),void 0!==s.client&&""!==s.client){var k=s.client.split("/")[0],y=s.client.split("/")[1];switch(k){case"Web":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-fish"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Bird":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-bird"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Dart":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-dart"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"ElvesOnline":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-moon"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Mobile":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-mobile"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Windows":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-windows"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Linux":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-linux"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IceNet":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-icenet"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Extension":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-extension"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Edge":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-edge"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Other":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-other"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"PC":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-pc2"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"iOS":case"macOS":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apple"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Android":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apk"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Chrome":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-chrome"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"VSCode":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-vscode"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IDEA":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-idea"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Python":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-python"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Golang":o=o+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+y+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-golang"></use></svg></span>')+'<span class="fn__space5"></span>\n'}}if(e?o+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+s.userName+"', '"+s.oId+'\', true)" class="item">@'+s.userName+"</a>\n                        <a onclick=\"ChatRoom.report('"+s.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n                    </details-menu>\n                </details>\n':o+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+s.userName+"', '"+s.oId+'\', true)" class="item">@'+s.userName+"</a>\n                        <a onclick=\"ChatRoom.at('"+s.userName+"', '"+s.oId+'\', false)" class="item">引用</a>\n                        <a onclick="ChatRoom.repeat(\''+s.oId+'\')" class="item">复读机</a>\n                        <a onclick="ChatRoom.remark(\''+s.userOId+"', '"+s.userName+'\')" class="item">备注</a>\n                        <a onclick="ChatRoom.report(\''+s.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n'+n+"                    </details-menu>\n                </details>\n",o+="        </div>\n    </div>\n</div></div>",i){$("#chats").append(o);d=$("#chats>div.fn-none");d.show(),d.removeClass("fn-none")}else if(c){let t=++Label.plusN;1==t&&($("#chats").prepend("<div id='stacked' class='fn__flex' style='position:relative;display:none;'><span id='plusOne' onclick='ChatRoom.plusOne()' style='display:block;margin-left: 20px'><svg style='width: 30px; height: 20px; cursor: pointer;'><use xlink:href='#plusOneIcon'></use></svg></span></div>"),r=$("#chats>div.latest"),$("#stacked").prepend(r),r.find("#userName").show(),r.removeClass("latest"));let a=$("#stacked");1!=t&&a.fadeOut(100),setTimeout(function(){a.append(o),a.height(a.height()+27+"px");var e=$("#stacked>div.fn-none");e.show(),e.css("left",9*t+"px"),e.css("top",27*t+"px"),e.css("position","absolute"),e.find(".chats__content").css("background-color",t%2==0?"rgb(240 245 254)":"rgb(245 245 245)"),e.removeClass("fn-none"),a.fadeIn(200)},100)}else{$("#plusOne").remove(),s.md&&(Label.latestMessage=s.md,Label.plusN=0);l=$("#chats"),u=(l.find(".latest").removeClass("latest"),l.prepend(o),$("#chats>div.fn-none"));u.slideDown(200),u.addClass("latest"),u.removeClass("fn-none")}t&&ChatRoom.initNewWeather(s.oId)}}},initNewWeather:function(e){var e=document.getElementById("weather_"+e),t=echarts.init(e,null,{renderer:"svg"}),a={CLEAR_DAY:"晴",CLEAR_NIGHT:"晴",PARTLY_CLOUDY_DAY:"多云 ",PARTLY_CLOUDY_NIGHT:"多云",CLOUDY:"阴",LIGHT_HAZE:"轻度雾霾",MODERATE_HAZE:"中度雾霾",HEAVY_HAZE:"重度雾霾",LIGHT_RAIN:"小雨",MODERATE_RAIN:"中雨",HEAVY_RAIN:"大雨",STORM_RAIN:"暴雨",FOG:"雾",LIGHT_SNOW:"小雪",MODERATE_SNOW:"中雪",HEAVY_SNOW:"大雪",STORM_SNOW:"暴雪",DUST:"浮尘",SAND:"沙尘",WIND:"大风"},o={};o.date=e.dataset.date.split(","),o.max=e.dataset.max.split(","),o.min=e.dataset.min.split(","),o.weatherCode=e.dataset.code.split(","),o.weatherName=[],o.t=e.dataset.t,o.st=e.dataset.st;for(var n=0;n<o.weatherCode.length;n++)o.weatherName.push(a[o.weatherCode[n]]);e={title:{text:o.t,subtext:o.st,left:"center",top:"top",textStyle:{fontSize:24},subtextStyle:{fontSize:14}},grid:{show:!0,backgroundColor:"transparent",opacity:.3,borderWidth:"0",top:"200",bottom:"50"},tooltip:{trigger:"axis"},legend:{show:!1},xAxis:[{type:"category",boundaryGap:!1,position:"top",offset:100,zlevel:100,axisLine:{show:!1},axisTick:{show:!1},axisLabel:{interval:0,formatter:["{a|{value}}"].join("\n"),rich:{a:{fontSize:14}}},nameTextStyle:{},data:o.date},{type:"category",boundaryGap:!1,position:"top",offset:20,zlevel:100,axisLine:{show:!1},axisTick:{show:!1},axisLabel:{interval:0,formatter:function(e,t){return"{"+t+"| }\n{b|"+e+"}"},rich:{0:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${o.weatherCode[0]}.svg`},height:40,width:40},1:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${o.weatherCode[1]}.svg`},height:40,width:40},2:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${o.weatherCode[2]}.svg`},height:40,width:40},3:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${o.weatherCode[3]}.svg`},height:40,width:40},4:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${o.weatherCode[4]}.svg`},height:40,width:40},b:{fontSize:12,lineHeight:30,height:20}}},nameTextStyle:{fontWeight:"bold",fontSize:19},data:o.weatherName}],yAxis:{type:"value",show:!1,axisLabel:{formatter:"{value} °C",color:"white"}},series:[{name:"最高气温",type:"line",data:o.max,symbol:"emptyCircle",symbolSize:10,showSymbol:!0,smooth:!0,itemStyle:{normal:{color:"#C95843"}},label:{show:!0,position:"top",formatter:"{c} °C"},lineStyle:{width:1},areaStyle:{opacity:1,color:"transparent"}},{name:"最低气温",type:"line",data:o.min,symbol:"emptyCircle",symbolSize:10,showSymbol:!0,smooth:!0,itemStyle:{normal:{color:"blue"}},label:{show:!0,position:"bottom",formatter:"{c} °C"},lineStyle:{width:1},areaStyle:{opacity:1,color:"transparent"}}]},t.setOption(e)},imgViewer:null,imgWaitting:!1,imageViewer:function(){if(!this.imgViewer||$("div.vditor-reset.ft__smaller img:not(.ft__smaller,.emoji,.ext-emoji,*[src*='shield'],*[src*='/gen?'])").length!==this.imgViewer.length){this.imgViewer=this.imgViewer||new Viewer(document.querySelector("#chats"),{inline:!1,className:"PWLimgViwer",filter:e=>!e.parentElement.classList.contains("ft__smaller")&&!e.parentElement.classList.contains("ext-emoji")&&!e.classList.contains("emoji")&&e.src.indexOf("shield")<0&&e.src.indexOf("/gen?")<0,title(){let e=this.images[$(".PWLimgViwer .viewer-active").attr("data-index")];for(;!(e=e.parentElement).querySelector(".avatar"););return"From @"+e.querySelector(".avatar").getAttribute("aria-label")}});const e=function(){return setTimeout(()=>{ChatRoom.imgViewer.isShown?e():(ChatRoom.imgWaitting=!1,ChatRoom.imgViewer.update())},1e3),!0};this.imgWaitting=this.imgWaitting||e()}},addRobotMsg:function(e,t){$("#robotMsgList").prepend(e);$(".robot-msg-item")&&50<$(".robot-msg-item").length&&$(".robot-msg-item:gt(n-1)").remove()},changeCatchUser:function(e){var t;e&&0<e.length?(t='<div class="robot-msg-item"><div class="robot-msg-content">当前捕获用户:'+e+"</div></div></div>",$("#robotMsgList").prepend(t)):$("#robotMsgList").prepend('<div class="robot-msg-item"><div class="robot-msg-content">当前不存在需要捕获的用户</div></div></div>'),window.localStorage.robot_list=e,catchUsers=e.split(",")},initCatchUser:function(){$("#robotBtn").click(function(){$("#robotBox").show(200),$("#robotBtn").hide(200),setTimeout(()=>{$("#robotBox").addClass("robot-active"),$("#robotBox").attr("style","height:"+(window.innerHeight-25-58)+"px"),$("#robotMsgList").attr("style","height:"+(window.innerHeight-85-58)+"px")},220)}),$("#robotClose").click(function(){var e=$("#robotBox");setTimeout(()=>{$(".robot-chat-input").val(""),$("#robotBox").hide(200),$("#robotBtn").show(200)},e.hasClass("robot-active")?420:1),e.removeClass("robot-active"),e.css("height","")}),$("#robotMinimize").click(function(){$("#robotBox").toggleClass("robot-active")}),$("#clearRobotMsg").click(function(){$(".robot-msg-item").remove()}),$("#catch-word").click(function(){window.localStorage["catch-word-flag"]=$("#catch-word").prop("checked")}),$("#changeCatchUsers").click(function(){Util.alert('<div class="form fn__flex-column">\n<label>\n  <div class="ft__smaller" style="float: left">将捕获的用户id填写到下方输入框；<br>多个用户id的情况用英文逗号隔开。</div>\n  <div class="fn-hr5 fn__5"></div>\n  <input type="text" id="robot-catch-user">\n</label>\n<div class="fn-hr5"></div>\n<div class="fn__flex" style="margin-top: 15px; justify-content: flex-end;">\n  <button class="btn btn--confirm" onclick=\'ChatRoom.changeCatchUser($("#robot-catch-user").val());Util.closeAlert();\'>确认</button>\n</div>\n</div>',"编辑捕获用户列表"),$("#robot-catch-user").val(window.localStorage.robot_list||"")});var e=window.localStorage.robot_list||"";ChatRoom.changeCatchUser(e);let t=!1;"true"===window.localStorage["catch-word-flag"]&&(t=!0),$("#catch-word").prop("checked",t)},loadAvatarPendant:function(){var e=(new Date).getFullYear(),t=(t=((new Date).getMonth()+1).toString())[1]?t:"0"+t,a=(new Date).getDate(),o=e+`-${t}-`+a,n={2022:["2022-01-31","2022-02-06"],2023:["2023-01-21","2023-01-27"],2024:["2024-02-09","2024-02-15"],2025:["2025-01-28","2025-02-03"],2026:["2026-02-16","2026-02-22"],2027:["2027-02-06","2027-02-12"]},s={2022:["2022-09-10","2022-09-12"],2023:["2023-09-29","2023-10-01"],2024:["2024-09-17","2024-09-19"],2025:["2025-10-06","2025-10-09"],2026:["2026-09-25","2026-09-27"],2027:["2027-09-15","2027-09-17"]},i=document.querySelector("body");10==t&&a<=7?i.classList.add("NationalDay"):12==t&&24<=a&&12==t&&a<=25?i.classList.add("Christmas"):(t=new Date(o).getTime(),new Date(s[e][0]).getTime()<=t&&new Date(s[e][1]).getTime()>=t?i.classList.add("MidAutumnFestival"):new Date(n[e][0]).getTime()<=t&&new Date(n[e][1]).getTime()>=t&&i.classList.add("SpringFestival"))},isMobile:function(){for(var e=navigator.userAgent,t=["Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"],a=!1,o=0;o<t.length;o++)if(0<e.indexOf(t[o])){a=!0;break}var n=window.screen.width,s=window.screen.height;return a=325<n&&s<750?!0:a}});