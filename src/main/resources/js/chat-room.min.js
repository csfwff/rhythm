...
> ${t}</span>
`,!1)}$(window).scrollTop(0)},remarkList:{},remark:function(e,t){console.log(e,t);t=prompt(`要给 ${t} 备注什么呢?`);console.log(t),null!==t&&(""===t?delete ChatRoom.remarkList[e]:ChatRoom.remarkList[e]=t,localStorage.setItem("user_remark",JSON.stringify(ChatRoom.remarkList)))},filterContent:function(e){var t=document.createElement("div");return t.innerHTML=e,t.querySelectorAll("img").forEach(e=>{e.src=e.src+"?imageView2/1/w/150/h/150/interlace/0/q/90"}),t.innerHTML},renderRedPacket:function(i,e,t,a,n,o){let r=!1,l=-1,c,s;if(void 0!==n&&(c=n.winnerResult,s=n.diceParticles),e===t)for(let e=0;e<i.length;e++){var d=i[e];d.userMoney>l&&(l=d.userMoney)}for(let s=0;s<i.length;s++){var u=i[s],p=u.userMoney,m=u.dice,h=u.userName;h===Label.currentUser&&(void 0!==p?0<p?$("#redPacketIGot").text("抢到了 "+p+" 积分"):0==p?$("#redPacketIGot").text("恭喜你，抢了个寂寞"):$("#redPacketIGot").text("什么运气，你竟然被反向抢红包了"):void 0!==m&&$("#redPacketIGot").text("押注 "+m.chips+" 积分"),r=!0);let e="",t=h;switch(e=void 0!==m?m.bet:e){case"big":t=h+" (押大)";break;case"small":t=h+" (押小)";break;case"leopard":t=h+" (豹子)"}var f=u.time;let a="",n=`<li class="fn__flex menu__item">${a=void 0!==u.avatar?`<img class="avatar avatar--mid" style="margin-right: 10px; background-image: none; background-color: transparent;" src="${u.avatar}">`:a}
<div class="fn__flex-1" style="text-align: left !important;">
