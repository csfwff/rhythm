...
> ${t}</span>
`,!1)}$(window).scrollTop(0)},renderRedPacket:function(i,e,t,a,n,s){let l=!1,r=-1,c,o;if(void 0!==n&&(c=n.winnerResult,o=n.diceParticles),e===t)for(let e=0;e<i.length;e++){var d=i[e];d.userMoney>r&&(r=d.userMoney)}for(let o=0;o<i.length;o++){var u=i[o],p=u.userMoney,m=u.dice,f=u.userName;f===Label.currentUser&&(void 0!==p?0<p?$("#redPacketIGot").text("抢到了 "+p+" 积分"):0==p?$("#redPacketIGot").text("恭喜你，抢了个寂寞"):$("#redPacketIGot").text("什么运气，你竟然被反向抢红包了"):void 0!==m&&$("#redPacketIGot").text("押注 "+m.chips+" 积分"),l=!0);let e="",t=f;switch(e=void 0!==m?m.bet:e){case"big":t=f+" (押大)";break;case"small":t=f+" (押小)";break;case"leopard":t=f+" (豹子)"}var h=u.time;let a="",n=`<li class="fn__flex menu__item">${a=void 0!==u.avatar?`<img class="avatar avatar--mid" style="margin-right: 10px; background-image: none; background-color: transparent;" src="${u.avatar}">`:a}
<div class="fn__flex-1" style="text-align: left !important;">
<h2 class="list__user"><a href="${Label.servePath}/member/${f}">${t}</a>
