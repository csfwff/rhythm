...
> ${t}</span>
`,!1)}$(window).scrollTop(0)},remarkList:{},remark:function(e,t){t=prompt(`要给 ${t} 备注什么呢?`);null!==t&&(""===t?delete ChatRoom.remarkList[e]:ChatRoom.remarkList[e]=t,localStorage.setItem("user_remark",JSON.stringify(ChatRoom.remarkList)))},filterContent:function(e){var t=document.createElement("div");return t.innerHTML=e,t.querySelectorAll("img").forEach(e=>{e.setAttribute("originalsrc",e.src),e.src.startsWith("https://file.fishpi.cn")&&(e.src=e.src.split("?")[0]+"?imageView2/0/w/150/h/150/interlace/0/q/90")}),t.innerHTML},renderRedPacket:function(i,e,t,a,s,o){let r=!1,l=-1,c,n;if(void 0!==s&&(c=s.winnerResult,n=s.diceParticles),e===t)for(let e=0;e<i.length;e++){var d=i[e];d.userMoney>l&&(l=d.userMoney)}for(let n=0;n<i.length;n++){var h=i[n],u=h.userMoney,m=h.dice,p=h.userName;p===Label.currentUser&&(void 0!==u?0<u?$("#redPacketIGot").text("抢到了 "+u+" 积分"):0==u?$("#redPacketIGot").text("恭喜你，抢了个寂寞"):$("#redPacketIGot").text("什么运气，你竟然被反向抢红包了"):void 0!==m&&$("#redPacketIGot").text("押注 "+m.chips+" 积分"),r=!0);let e="",t=p;switch(e=void 0!==m?m.bet:e){case"big":t=p+" (押大)";break;case"small":t=p+" (押小)";break;case"leopard":t=p+" (豹子)"}var v=h.time;let a="",s=`<li class="fn__flex menu__item">${a=void 0!==h.avatar?`<img class="avatar avatar--mid" style="margin-right: 10px; background-image: none; background-color: transparent;" src="${h.avatar}">`:a}
<div class="fn__flex-1" style="text-align: left !important;">
<h2 class="list__user"><a href="${Label.servePath}/member/${p}">${t}</a>
</h2>`;0<u&&u===l?(l=-1,s+="<span class='green small btn'>来自老王的认可</span><br>\n"):0===u?s+="<span class='red small btn'>0溢事件</span><br>\n":u<0&&(s+="<span class='yellow small btn'>抢红包有风险</span><br>\n"),void 0!==c&&(c===m.bet?s+="<span class='green small btn'>运气好而已</span><br>\n":s+="<span class='red small btn'>别玩了</span><br>\n");let o;o=void 0===u&&void 0!==m?m.chips:u,s+=`<span class="ft__fade ft__smaller">${v}</span>
    </div>
    <div class="fn__flex-center">${o} 积分</div>
</li>
`,$("#redPacketList").append(s)}if(r||$("#redPacketIGot").text(Label.currentUser===o?"金主来了":"你错过了这个红包"),void 0!==a&&0<a.length&&-1===(index=a.indexOf(Label.currentUser))&&($("#msg").text("这个红包属于 "+a),$("#redPacketIGot").text(Label.currentUser===o?"金主来了":"这个红包不属于你")),void 0!==c){let e=" ",t=0;for(key in n)t+=n[key];switch(c){case"big":e+=t+"点大";break;case"small":e+=t+"点小";break;case"leopard":e+="豹子通杀"}$("#redPacketIGot").text(n+e)}},bet:function(e){Util.alert('<div class="form fn__flex-column">\n<label id="betRadio">\n  <input type="radio" name="bet" value="big" checked>大\n  <input type="radio" name="bet" value="small">小\n  <input type="radio" name="bet" value="leopard">豹子\n  <div class="ft__smaller ft__fade" style="float: left">筹码</div>\n  <div class="fn-hr5 fn__5"></div>\n  <input type="number" min="32" max="100" required="" value="32" id="chipsLabel" name=\'chips\' onkeypress="return(/[\\d]/.test(String.fromCharCode(event.keyCode)))">\n</label>\n<div class="fn__flex" style="margin-top: 15px">\n  <button class="btn btn--confirm" onclick="ChatRoom.unpackRedPacket('+e+');Util.clearAlert()">押注</button>\n</div>\n</div>',"买定离手"),$("#chipsLabel").on("change",function(){100<$("#chipsLabel").val()&&$("#chipsLabel").val("100"),$("#chipsLabel").val()<=32&&$("#chipsLabel").val("32")})},selectGesture:function(e){Util.alert(`<div class="form fn__flex-column select-center">
<div>
...
</ul></div>`,"红包"),ChatRoom.renderRedPacket(t.who,t.info.count,t.info.got,t.recivers,t.diceRet,t.info.userName),t.info.count===t.info.got&&($("#chatroom"+a).find(".hongbao__item").css("opacity",".36").attr("onclick","ChatRoom.unpackRedPacket("+a+")"),$("#chatroom"+a).find(".hongbao__item").hasClass("opened")||$("#chatroom"+a).find(".hongbao__item").addClass("opened"),!0===t.dice?$("#chatroom"+a).find(".redPacketDesc").html("已开盘"):$("#chatroom"+a).find(".redPacketDesc").html("已经被抢光啦"))}else Util.alert(t.msg)},error:function(e){Util.alert(e.msg)}})},plusOne:function(){ChatRoom.editor.setValue(Label.latestMessage),ChatRoom.send()},renderMsg:function(i,r){if(!(0<ChatRoom.shileds.indexOf(i.userName))){var l=i.userName,c=i.content,d=i.md||"",h=i.userAvatarURL,u=ChatRoom.remarkList[i.userOId];if(!r&&catchUsers.includes(l)&&-1==c.indexOf('"msgType":"redPacket"')){var m='<div class="robot-msg-item"><div class="avatar" style="background-image: url('+h+')"></div><div class="robot-msg-content"><div class="robot-username"><p>'+l+"</p></div> "+c+' <div class="fn__right" style="margin-top: 5px; font-size: 10px;">'+i.time+"</div></div></div>";ChatRoom.addRobotMsg(m)}else if(!r&&$("#catch-word").prop("checked")&&-1==c.indexOf('"msgType":"redPacket"')&&(d.startsWith("鸽 ")||d.startsWith("小冰 ")||d.startsWith("凌 ")||d.startsWith("ida "))){m='<div class="robot-msg-item"><div class="avatar" style="background-image: url('+h+')"></div><div class="robot-msg-content"><div class="robot-username"><p>'+l+"</p></div> "+c+' <div class="fn__right" style="margin-top: 5px; font-size: 10px;">'+i.time+"</div></div></div>";ChatRoom.addRobotMsg(m)}else{let e=!1,t=!1,a=!1;d=Label.latestMessage===i.md;try{var p=$.parseJSON(i.content.replace("<p>","").replace("</p>",""));if("redPacket"===p.msgType){e=!0;let t="未知类型红包",a="ChatRoom.unpackRedPacket('"+i.oId+"')";switch(p.type){case"random":t="拼手气红包";break;case"average":t="普通红包";break;case"specify":t="专属红包";break;case"heartbeat":t="心跳红包 (慎抢)";break;case"rockPaperScissors":t="石头剪刀布红包",p.senderId!=Label.currentUserId&&(a="");break;case"dice":if(t="摇骰子",p.senderId!==Label.currentUserId){let e=!1;for(idx in p.who)if(p.who[idx].userId===Label.currentUserId){e=!0;break}e||(a="ChatRoom.bet('"+i.oId+"')")}}if(Number(p.count)===Number(p.got)){let e="已经被抢光啦";"dice"===p.type&&(e="已开盘"),i.content='<div style="opacity: .36;" class="hongbao__item fn__flex-inline" onclick="ChatRoom.unpackRedPacket(\''+i.oId+'\')">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+p.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+p.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n'+e+"\n        </div>\n    </div>\n</div>"}else"rockPaperScissors"===p.type&&p.senderId!=Label.currentUserId?i.content='<div class="hongbao__item fn__flex-inline" >\n    <div class="hongbao__finger_guessing">\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+i.oId+',\'0\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+i.oId+',\'1\');"></div>\n        <div class="hongbao__finger_guessing_icon" onclick="event.stopPropagation();Util.clearAlert();ChatRoom.unpackRedPacket('+i.oId+',\'2\');"></div>\n    </div>\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+p.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+p.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>':i.content='<div class="hongbao__item fn__flex-inline" onclick="'+a+'">\n    <svg class="ft__red hongbao__icon">\n        <use xlink:href="#redPacketIcon"></use>\n    </svg>\n    <div>\n        <div>'+p.msg+"<br><b>"+t+'</b></div>\n        <div><svg style="vertical-align: -2px; width: 13px; height: 13px"><use xlink:href="#coin"></use></svg> '+p.money+'</div>\n        <div class="ft__smaller ft__fade redPacketDesc">\n        </div>\n    </div>\n</div>'}else"weather"===p.msgType?(t=!0,i.content='<div id="weather_'+i.oId+'" style="width: 300px;height:280px;" data-date="'+p.date+'" data-code="'+p.weatherCode+'" data-max="'+p.max+'" data-min="'+p.min+'" data-t="'+p.t+'" data-st="'+p.st+'"></div>'):"music"===p.msgType&&(a=!0,i.content='<div class="music-player"><img class="music-player-img" src="'+(""===p.coverURL?Label.servePath+"/images/music/cat.gif":p.coverURL)+'" /><div class="music-player-box"><div class="music-player-title">'+p.title+'</div><div class="music-player-controller"  data-source="'+p.source+'" data-cover="'+p.coverURL+'" data-title="'+p.title+'" data-from="'+p.from+'"><span onclick="ChatRoom.playSound.add(this)">加入列表</span> | <span onclick="ChatRoom.playSound.play(this)">立即播放</span></div></div></div>')}catch(e){}let s="",o="<a onclick=\"ChatRoom.shiled('"+i.userName+"')\" class=\"item\" style='color: red'>屏蔽Ta</a>\n";void 0!==i.userNickname&&""!==i.userNickname?i.userNickname=i.userNickname+" ("+i.userName+")":i.userNickname=i.userName,Label.currentUser===i.userName&&(s=" chats__item--me",o='<a onclick="ChatRoom.revoke('+i.oId+')" class="item">撤回</a>\n'),Label.level3Permitted&&(o='<a onclick="ChatRoom.revoke('+i.oId+')" class="item"><svg><use xlink:href="#administration"></use></svg> 撤回</a>\n');try{var v=i.content.replace("<p>","").replace("</p>",""),g=Util.parseDom(v);let t=!1,a="",s=0;for(let e=0;e<g.length;e++){var f=g.item(e);void 0!==f.src&&(t=!0,0!==s&&(a+=","),a+="'"+f.src+"'",s++)}t&&(o+='<a onclick="ChatRoom.addEmoji('+a+')" class="item">一键收藏表情</a>')}catch(e){}let n='<div class="fn-none">';if(n=(n+='<div id="chatroom'+i.oId+'" class="fn__flex chats__item'+s+'">\n    <a href="/member/'+i.userName+'" style="height: 38px">\n        <div class="avatar tooltipped__user" aria-label="'+i.userName+'" style="background-image: url(\''+i.userAvatarURL+'\');"></div>\n    </a>\n    <div class="chats__content">\n        <div class="chats__arrow"></div>\n')+('<div id="userName" class="ft__fade ft__smaller" style="padding-bottom: 3px;border-bottom: 1px solid #eee">\n    <span class="ft-gray">'+(null!=u?u+"-":"")+i.userNickname+"</span>&nbsp;\n"),void 0!==i.sysMetal&&""!==i.sysMetal){var b=JSON.parse(i.sysMetal).list;if(void 0!==b)for(let e=0;e<b.length;e++){var y=b[e];n+="<img title='"+y.name+" - "+y.description+"' src='"+Util.genMiniMetal(y.attr)+"'/>"}}if(n=(n+="</div>")+('        <div class="vditor-reset ft__smaller '+Label.chatRoomPictureStatus+'" style="margin-top: 3px">\n            '+ChatRoom.filterContent(i.content)+'\n        </div>\n        <div class="ft__smaller ft__fade fn__right date-bar">\n            '+i.time+'\n                <span class="fn__space5"></span>\n'),void 0!==i.client&&""!==i.client){var k=i.client.split("/")[0],x=i.client.split("/")[1];switch(k){case"Web":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-fish"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Bird":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-bird"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Dart":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-dart"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"ElvesOnline":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-moon"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Mobile":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-mobile"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Windows":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-windows"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Linux":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-linux"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IceNet":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-icenet"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Extension":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-extension"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Edge":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-edge"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Other":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-other"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"PC":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-pc2"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"iOS":case"macOS":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apple"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Android":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-apk"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Chrome":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-chrome"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"VSCode":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-vscode"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"IDEA":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-idea"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Python":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-python"></use></svg></span>')+'<span class="fn__space5"></span>\n';break;case"Golang":n=n+('<span class="tooltipped tooltipped-n" aria-label="'+k+" "+x+'"><svg style="vertical-align: -3px;"><use xlink:href="#ic-golang"></use></svg></span>')+'<span class="fn__space5"></span>\n'}}if(e||t||a?n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+i.userName+"', '"+i.oId+'\', true)" class="item">@'+i.userName+"</a>\n                        <a onclick=\"ChatRoom.report('"+i.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n                    </details-menu>\n                </details>\n':n+='                <details class="details action__item fn__flex-center">\n                    <summary>\n                        ···\n                    </summary>\n                    <details-menu class="fn__layer">\n                        <a onclick="ChatRoom.at(\''+i.userName+"', '"+i.oId+'\', true)" class="item">@'+i.userName+"</a>\n                        <a onclick=\"ChatRoom.at('"+i.userName+"', '"+i.oId+'\', false)" class="item">引用</a>\n                        <a onclick="ChatRoom.repeat(\''+i.oId+'\')" class="item">复读机</a>\n                        <a onclick="ChatRoom.remark(\''+i.userOId+"', '"+i.userName+'\')" class="item">备注</a>\n                        <a onclick="ChatRoom.report(\''+i.oId+'\')" class="item"><svg><use xlink:href="#icon-report"></use></svg> 一键举报</a>\n'+o+"                    </details-menu>\n                </details>\n",n+="        </div>\n    </div>\n</div></div>",r){$("#chats").append(n);h=$("#chats>div.fn-none");h.show(),h.removeClass("fn-none")}else if(d){let t=++Label.plusN;1==t&&($("#chats").prepend("<div id='stacked' class='fn__flex' style='position:relative;display:none;'><span id='plusOne' onclick='ChatRoom.plusOne()' style='display:block;margin-left: 20px'><svg style='width: 30px; height: 20px; cursor: pointer;'><use xlink:href='#plusOneIcon'></use></svg></span></div>"),l=$("#chats>div.latest"),$("#stacked").prepend(l),l.find("#userName").show(),l.removeClass("latest"));let a=$("#stacked");1!=t&&a.fadeOut(100),setTimeout(function(){a.append(n),a.height(a.height()+27+"px");var e=$("#stacked>div.fn-none");e.show(),e.css("left",9*t+"px"),e.css("top",27*t+"px"),e.css("position","absolute"),e.find(".chats__content").css("background-color",t%2==0?"rgb(240 245 254)":"rgb(245 245 245)"),e.removeClass("fn-none"),a.fadeIn(200)},100)}else{$("#plusOne").remove(),i.md&&(Label.latestMessage=i.md,Label.plusN=0);c=$("#chats"),m=(c.find(".latest").removeClass("latest"),c.prepend(n),$("#chats>div.fn-none"));m.slideDown(200),m.addClass("latest"),m.removeClass("fn-none")}t&&ChatRoom.initNewWeather(i.oId)}}},initNewWeather:function(e){var e=document.getElementById("weather_"+e),t=echarts.init(e,null,{renderer:"svg"}),a={CLEAR_DAY:"晴",CLEAR_NIGHT:"晴",PARTLY_CLOUDY_DAY:"多云 ",PARTLY_CLOUDY_NIGHT:"多云",CLOUDY:"阴",LIGHT_HAZE:"轻度雾霾",MODERATE_HAZE:"中度雾霾",HEAVY_HAZE:"重度雾霾",LIGHT_RAIN:"小雨",MODERATE_RAIN:"中雨",HEAVY_RAIN:"大雨",STORM_RAIN:"暴雨",FOG:"雾",LIGHT_SNOW:"小雪",MODERATE_SNOW:"中雪",HEAVY_SNOW:"大雪",STORM_SNOW:"暴雪",DUST:"浮尘",SAND:"沙尘",WIND:"大风"},s={};s.date=e.dataset.date.split(","),s.max=e.dataset.max.split(","),s.min=e.dataset.min.split(","),s.weatherCode=e.dataset.code.split(","),s.weatherName=[],s.t=e.dataset.t,s.st=e.dataset.st;for(var o=0;o<s.weatherCode.length;o++)s.weatherName.push(a[s.weatherCode[o]]);e={title:{text:s.t,subtext:s.st,left:"center",top:"top",textStyle:{fontSize:24},subtextStyle:{fontSize:14}},grid:{show:!0,backgroundColor:"transparent",opacity:.3,borderWidth:"0",top:"200",bottom:"50"},tooltip:{trigger:"axis"},legend:{show:!1},xAxis:[{type:"category",boundaryGap:!1,position:"top",offset:100,zlevel:100,axisLine:{show:!1},axisTick:{show:!1},axisLabel:{interval:0,formatter:["{a|{value}}"].join("\n"),rich:{a:{fontSize:14}}},nameTextStyle:{},data:s.date},{type:"category",boundaryGap:!1,position:"top",offset:20,zlevel:100,axisLine:{show:!1},axisTick:{show:!1},axisLabel:{interval:0,formatter:function(e,t){return"{"+t+"| }\n{b|"+e+"}"},rich:{0:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${s.weatherCode[0]}.svg`},height:40,width:40},1:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${s.weatherCode[1]}.svg`},height:40,width:40},2:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${s.weatherCode[2]}.svg`},height:40,width:40},3:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${s.weatherCode[3]}.svg`},height:40,width:40},4:{backgroundColor:{image:Label.servePath+`/images/weather/svg/${s.weatherCode[4]}.svg`},height:40,width:40},b:{fontSize:12,lineHeight:30,height:20}}},nameTextStyle:{fontWeight:"bold",fontSize:19},data:s.weatherName}],yAxis:{type:"value",show:!1,axisLabel:{formatter:"{value} °C",color:"white"}},series:[{name:"最高气温",type:"line",data:s.max,symbol:"emptyCircle",symbolSize:10,showSymbol:!0,smooth:!0,itemStyle:{normal:{color:"#C95843"}},label:{show:!0,position:"top",formatter:"{c} °C"},lineStyle:{width:1},areaStyle:{opacity:1,color:"transparent"}},{name:"最低气温",type:"line",data:s.min,symbol:"emptyCircle",symbolSize:10,showSymbol:!0,smooth:!0,itemStyle:{normal:{color:"blue"}},label:{show:!0,position:"bottom",formatter:"{c} °C"},lineStyle:{width:1},areaStyle:{opacity:1,color:"transparent"}}]},t.setOption(e)},playSound:{list:[],mode:0,playing:!1,isShow:!1,index:0,ele:null,timer:null,isShowList:!1,isSHowVoice:!1,init(){var e=document.querySelector("#music-core-item");let t=document.querySelector(".music-play-icon"),a=document.querySelector(".music-box"),s=document.querySelector(".music-current"),o=document.querySelector(".music-duration"),n=document.querySelector(".music-title"),i=document.querySelector(".music-img-item");(this.ele=e).addEventListener("ended",()=>{this.playing=!1,clearInterval(this.timer),t.src=Label.servePath+"/images/music/circle_play.png",a.classList.remove("playing"),this.autoNext()}),e.addEventListener("play",()=>{t.src=Label.servePath+"/images/music/circle_pause.png",a.classList.add("playing"),this.timer=setInterval(()=>{s.innerHTML=this.secondsToTime(this.ele.currentTime)})}),e.addEventListener("pause",()=>{clearInterval(this.timer),t.src=Label.servePath+"/images/music/circle_play.png",a.classList.remove("playing")}),e.addEventListener("canplay",()=>{s.innerHTML=this.secondsToTime(this.ele.currentTime),o.innerHTML=this.secondsToTime(this.ele.duration),n.innerHTML=this.list[this.index].title;var e=this.list[this.index].cover;i.src=""===e?Label.servePath+"/images/music/cat.gif":e})},secondsToTime(e){let t,a=0;return 59<(e=parseInt(e))?(9<(t=Math.floor(e/60))?t:"0"+t)+":"+(9<(a=e%60)?a:"0"+a):"00:"+(9<(a=e)?a:"0"+a)},toggleMode(){var e=document.querySelector(".music-mode-icon");0===this.mode?(this.mode=1,e.src=Label.servePath+"/images/music/shuffle.png",e.setAttribute("alt","顺序播放")):(this.mode=0,e.src=Label.servePath+"/images/music/repeat.png",e.setAttribute("alt","随机播放"))},add(e,t=!0){let a=e.parentElement.dataset;(a.source.startsWith("http://music.163.com/song")||a.source.startsWith("https://music.163.com/song"))&&(e=a.source.split("="),a.source=e[e.length-1]);e=this.list.findIndex(e=>e.source===a.source);-1!==e?this.index=e:(this.list.push(a),this.renderList(),t&&Util.notice("success",2e3,"已加入播放列表。"))},remove(e){this.list.splice(e,1),this.renderList(),Util.notice("success",2e3,"已移出播放列表。")},renderList(){var e=document.querySelector(".music-list-box");let t="";for(let e=0;e<this.list.length;e++){var a=this.list[e];t+='<div class="music-list-item">        <img src="'+a.cover+'" alt="">        <div class="music-list-title">'+a.title+'</div>        <div class="music-list-controller">            <span style="color: #198cff" data-i="'+e+'" onclick="ChatRoom.playSound.playIndex('+e+')">播放</span>            <span style="color: red" data-i="'+e+'" onclick="ChatRoom.playSound.remove('+e+')">移除</span>        </div>    </div>'}e.innerHTML=t},next(){0!==this.list.length&&(this.index+=1,this.index>=this.list.length&&(this.index=0),this.playIndex(this.index))},prev(){0!==this.list.length&&(--this.index,this.index<0&&(this.index=this.list.length-1),this.playIndex(this.index))},play(e){var t=e.parentElement.dataset;this.add(e,!1),(t.source.startsWith("http://music.163.com/song")||t.source.startsWith("https://music.163.com/song"))&&(e=t.source.split("="),t.source=e[e.length-1]),document.querySelector(".music-detail").innerHTML='<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width="100%" height=86 src="//music.163.com/outchain/player?type=2&id='+t.source+'&auto=1&height=66"></iframe>',this.playing=!1,this.togglePlay(),this.isShow||this.show()},playIndex(e){document.querySelector(".music-detail").innerHTML='<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width="100%" height=86 src="//music.163.com/outchain/player?type=2&id='+this.list[e].source+'&auto=1&height=66"></iframe>',this.playing=!1,this.index=e,this.togglePlay()},autoNext(){0===this.mode?this.next():this.playIndex(Math.floor(Math.random()*this.list.length))},togglePlay(){this.playing=!this.playing},hide(){this.isShow=!1;var e=document.querySelector("#musicBox");document.querySelector(".music-close-icon").src=Label.servePath+"/images/music/arrow_up.png",e.classList.remove("show"),this.isShowList&&this.toggleList()},show(){this.isShow=!0;var e=document.querySelector("#musicBox");document.querySelector(".music-close-icon").src=Label.servePath+"/images/music/arrow_down.png",e.classList.add("show")},toggleShow(){this.isShow?this.hide():this.show()},toggleList(){var e=document.querySelector(".music-list-box");this.isShowList=!this.isShowList,this.isShowList?e.classList.add("show"):e.classList.remove("show")},changeVoice(e){var e=e.value,t=document.querySelector(".music-voice-icon");t.src=80<e?Label.servePath+"/images/music/volume_3.png":30<e?Label.servePath+"/images/music/volume_2.png":0<e?Label.servePath+"/images/music/volume_1.png":Label.servePath+"/images/music/volume_off.png",this.ele.volume=e/100}},imgViewer:null,imgWaitting:!1,imageViewer:function(){if(!this.imgViewer||$("div.vditor-reset.ft__smaller img:not(.ft__smaller,.emoji,.ext-emoji,*[src*='shield'],*[src*='/gen?'])").length!==this.imgViewer.length){this.imgViewer=this.imgViewer||new Viewer(document.querySelector("#chats"),{inline:!1,className:"PWLimgViwer",filter:e=>!e.parentElement.classList.contains("ft__smaller")&&!e.parentElement.classList.contains("ext-emoji")&&!e.classList.contains("emoji")&&e.src.indexOf("shield")<0&&e.src.indexOf("/gen?")<0,title(){let e=this.images[$(".PWLimgViwer .viewer-active").attr("data-index")];for(;!(e=e.parentElement).querySelector(".avatar"););return"From @"+e.querySelector(".avatar").getAttribute("aria-label")}});const e=function(){return setTimeout(()=>{ChatRoom.imgViewer.isShown?e():(ChatRoom.imgWaitting=!1,ChatRoom.imgViewer.update())},1e3),!0};this.imgWaitting=this.imgWaitting||e()}},addRobotMsg:function(e,t){$("#robotMsgList").prepend(e);$(".robot-msg-item")&&50<$(".robot-msg-item").length&&$(".robot-msg-item:gt(n-1)").remove()},changeCatchUser:function(e){var t;e&&0<e.length?(t='<div class="robot-msg-item"><div class="robot-msg-content">当前捕获用户:'+e+"</div></div></div>",$("#robotMsgList").prepend(t)):$("#robotMsgList").prepend('<div class="robot-msg-item"><div class="robot-msg-content">当前不存在需要捕获的用户</div></div></div>'),window.localStorage.robot_list=e,catchUsers=e.split(",")},initCatchUser:function(){$("#robotBtn").click(function(){$("#robotBox").show(200),$("#robotBtn").hide(200),setTimeout(()=>{$("#robotBox").addClass("robot-active"),$("#robotBox").attr("style","height:"+(window.innerHeight-25-58)+"px"),$("#robotMsgList").attr("style","height:"+(window.innerHeight-85-58)+"px")},220)}),$("#robotClose").click(function(){var e=$("#robotBox");setTimeout(()=>{$(".robot-chat-input").val(""),$("#robotBox").hide(200),$("#robotBtn").show(200)},e.hasClass("robot-active")?420:1),e.removeClass("robot-active"),e.css("height","")}),$("#robotMinimize").click(function(){$("#robotBox").toggleClass("robot-active")}),$("#clearRobotMsg").click(function(){$(".robot-msg-item").remove()}),$("#catch-word").click(function(){window.localStorage["catch-word-flag"]=$("#catch-word").prop("checked")}),$("#changeCatchUsers").click(function(){Util.alert('<div class="form fn__flex-column">\n<label>\n  <div class="ft__smaller" style="float: left">将捕获的用户id填写到下方输入框；<br>多个用户id的情况用英文逗号隔开。</div>\n  <div class="fn-hr5 fn__5"></div>\n  <input type="text" id="robot-catch-user">\n</label>\n<div class="fn-hr5"></div>\n<div class="fn__flex" style="margin-top: 15px; justify-content: flex-end;">\n  <button class="btn btn--confirm" onclick=\'ChatRoom.changeCatchUser($("#robot-catch-user").val());Util.closeAlert();\'>确认</button>\n</div>\n</div>',"编辑捕获用户列表"),$("#robot-catch-user").val(window.localStorage.robot_list||"")});var e=window.localStorage.robot_list||"";ChatRoom.changeCatchUser(e);let t=!1;"true"===window.localStorage["catch-word-flag"]&&(t=!0),$("#catch-word").prop("checked",t)},loadAvatarPendant:function(){var e=(new Date).getFullYear(),t=(t=((new Date).getMonth()+1).toString())[1]?t:"0"+t,a=(new Date).getDate(),s=e+`-${t}-`+a,o={2022:["2022-01-31","2022-02-06"],2023:["2023-01-21","2023-01-27"],2024:["2024-02-09","2024-02-15"],2025:["2025-01-28","2025-02-03"],2026:["2026-02-16","2026-02-22"],2027:["2027-02-06","2027-02-12"]},n={2022:["2022-09-10","2022-09-12"],2023:["2023-09-29","2023-10-01"],2024:["2024-09-17","2024-09-19"],2025:["2025-10-06","2025-10-09"],2026:["2026-09-25","2026-09-27"],2027:["2027-09-15","2027-09-17"]},i=document.querySelector("body");10==t&&a<=7?i.classList.add("NationalDay"):12==t&&24<=a&&12==t&&a<=25?i.classList.add("Christmas"):(t=new Date(s).getTime(),new Date(n[e][0]).getTime()<=t&&new Date(n[e][1]).getTime()>=t?i.classList.add("MidAutumnFestival"):new Date(o[e][0]).getTime()<=t&&new Date(o[e][1]).getTime()>=t&&i.classList.add("SpringFestival"))},isMobile:function(){for(var e=navigator.userAgent,t=["Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"],a=!1,s=0;s<t.length;s++)if(0<e.indexOf(t[s])){a=!0;break}var o=window.screen.width,n=window.screen.height;return a=325<o&&n<750?!0:a}});