        ...
        success: function (result, textStatus) {
          if (0 === result.code) {
            ...
            if (Util.getParameterByName("r") !== "") {
              $("#registerBtn").attr(
                "onclick",
                'location.href = Label.servePath + "/register?r=" + Util.getParameterByName("r") + "&code=" + $("#registerVerifyCode").val()'
              );
            } else {
              $("#registerBtn").attr(
                "onclick",
                'location.href = Label.servePath + "/register?code=" + $("#registerVerifyCode").val()'
              );
            }
          } else {
            $("#registerTip")
              ...
              .removeClass("succ")
              .html("<ul><li>" + result.msg + "</li></ul>");
            $("#registerCaptchaImg").attr(
              "src",
              Label.servePath + "/captcha?code=" + Math.random()
            );
            $("#registerCaptcha").val("");
          }
        },
      ...
      $.ajax({
        ...
        success: function (result, textStatus) {
          if (0 === result.code) {
            ...
            $("#forgetBtn").attr(
              "onclick",
              'location.href = Label.servePath + "/reset-pwd?code=" + $("#resetPwdVerifyCode").val()'
            );
          } else {
