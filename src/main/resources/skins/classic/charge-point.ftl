        ...
        <div class="content">
            <div class="module">
                ...
                <div style="padding: 15px">
                    ...
                    <p style="color: rgba(205,80,0,0.91)"><b>请一定要在扫码时填写备注</b> <em>你的社区用户名+写给我们的话</em>，不要当不留名的雷锋哦！作为答谢，我们会向你的摸鱼派账号赠送对应的积分 😄 积分赠送标准为2000积分/10元，<b>每月封顶4000积分，请不要为了充积分而捐助哦！</b></p><br>
